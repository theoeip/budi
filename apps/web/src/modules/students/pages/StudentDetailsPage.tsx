...
export function StudentDetailsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Student: {student.nis}</h2>
        <p className="mt-1 text-sm text-gray-500">View and manage student details.</p>
      </div>
      <PageToolbar />
